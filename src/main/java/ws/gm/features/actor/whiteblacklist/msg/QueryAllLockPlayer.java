 ...
 */
public class QueryAllLockPlayer {
    ...
    public static class Response extends HttpResponseMsg {
        ...
        public Response(int simpleId, String playerId, String platformType, int outerRealmId, String createAtDate, String playerName, int remainLockTime) {
        ...
        public void setRemainLockTime(int remainLockTime) {
            this.remainLockTime = remainLockTime;
        }
    }
}
